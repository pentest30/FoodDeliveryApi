...
public class PlaceOrderCommandHandlerTests
{
    ...
    public async Task Handle_WithNegativeItemQuantity_ShouldThrowArgumentException()
    {
        ...
        var command = new PlaceOrderCommand
        {
            ...
            Items = new List<FoodDeliveryApi.Domain.ValueObjects.OrderItem>
            {
                new FoodDeliveryApi.Domain.ValueObjects.OrderItem("Pizza", -1, new Money(15.99m, "USD"), new Money(-15.99m, "USD")) // Invalid quantity
            },
            DeliveryFee = new Money(3.99m, "USD"),
            EtaMinutes = 30,
            RestaurantName = "Pizza Palace"
    ...
    public async Task Handle_WithNegativeItemPrice_ShouldThrowArgumentException()
    {
        ...
        var command = new PlaceOrderCommand
        {
            ...
            Items = new List<FoodDeliveryApi.Domain.ValueObjects.OrderItem>
            {
                new FoodDeliveryApi.Domain.ValueObjects.OrderItem("Pizza", 2, new Money(-15.99m, "USD"), new Money(-31.98m, "USD")) // Invalid price
            },
            DeliveryFee = new Money(3.99m, "USD"),
            EtaMinutes = 30,
            RestaurantName = "Pizza Palace"
